...
var getConfirmButton = function getConfirmButton() {
  return elementBySelector('.' + Actions.actions + ' .' + swalClasses.confirm);
};
var getCancelButton = function getCancelButton() {
  return elementBySelector('.' + Actions.actions + ' .' + swalClasses.cancel);
};
var getActions = function getActions() {
  return elementByClass(Actions.actions);
};
